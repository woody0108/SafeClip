...
object SubmissionDocument {
    fun createFields(input: SubmissionInput): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "incidentLocationDetail" to input.draft.locationDetail,
            "incidentLatitude" to input.draft.locationLatitude,
            "incidentLongitude" to input.draft.locationLongitude,
            "incidentLocationSource" to input.draft.locationSource,
